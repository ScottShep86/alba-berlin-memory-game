...
import players23 from '../data/players23';
...
export default function GameScreen() {
  ...
  const shuffleCards = () => {
    ...
    const shuffledUniqueCards = [...players23].sort(() => Math.random() - 0.5);

    // Create a new array with a maximum of 10 unique cards
    const limitedUniqueCards = shuffledUniqueCards.slice(0, 10);

    // Duplicate the limited cards to have a total of 20 cards
